...
use lib qw( /opt/local/lib/swish-e/perl );
...
#
#    swish.cgi $Revision: 1.20 $ Copyright (C) 2001 Bill Moseley swishscript@hank.org
...
#
#    $Id: swish.cgi.in,v 1.20 2004/10/02 23:59:01 whmoseley Exp $
#
####################################################################################
...
sub default_config {
    ...
    return {
        ...
        swish_binary    => '/opt/local/bin/swish-e',  # Location of swish-e binary
...
#         swish_index => [qw( indexes/i.general indexes/i.mmcif_pdbx.dic indexes/i.mmcif_std.dic indexes/i.mmcif_em.dic  indexes/i.mmcif_img.dic indexes/i.mmcif_ddl.dic indexes/i.mmcif_biosync.dic indexes/i.mmcif_bmrb.dic indexes/i.mmcif_ccp4.dic indexes/i.mmcif_mdb.dic indexes/i.mmcif_rcsb_nmr.dic indexes/i.mmcif_rcsb_xray.dic indexes/i.mmcif_sym.dic indexes/i.mmcif_emx.dic indexes/i.mmcif_nmr-star.dic)],
         swish_index => [qw( indexes/i.general indexes/i.mmcif_pdbx.dic indexes/i.mmcif_std.dic indexes/i.mmcif_em.dic  indexes/i.mmcif_img.dic indexes/i.mmcif_ddl.dic indexes/i.mmcif_biosync.dic indexes/i.mmcif_bmrb.dic indexes/i.mmcif_ccp4.dic indexes/i.mmcif_ma.dic indexes/i.mmcif_sym.dic indexes/i.mmcif_emx.dic indexes/i.mmcif_nmr-star.dic)],
        ...
        template => {
            package     => 'SWISH::dictTemplateDefault',
        },
        ...
        xtemplate => {
            ...
            file            => 'swish.tt',
            options         => {
                INCLUDE_PATH    => '/opt/local/share/swish-e',
                #PRE_PROCESS     => 'config',
            },
        },
...
swish.cgi $Revision: 1.20 $ Copyright (C) 2001 Bill Moseley search@hank.org
Example CGI program for searching with SWISH-E
