...
function onload_continued(){
    ...
    document.querySelector(".user-guide-container").style.top = `${height}px`;
    ...
    toggles.forEach((t) => {
            if(t) {
                t.addEventListener("click", function () {
                    ...
                    // entity.style.transform = entity.style.transform === "rotate(90deg)" ? "" : "rotate(90deg)";
...
function make_sidebar(){
    ...
    // stylesheet.setAttribute("class", "responsive-wizard");
    // stylesheet.innerHTML = "@media(max-width:800px){ body { } }";
